...
const productionSecretsSchema = z.object({
  // UTA-10: Neon Postgres — production database (NEVER in preview!)
  DATABASE_URL: z
    .string()
    .url()
    .describe('Neon production database connection string (pooled)'),
  DATABASE_POOL_URL: z
    .string()
    .url()
    .optional()
    .describe('Neon production connection-pool URL override'),
...
const stagingSecretsSchema = z.object({
  // UTA-10: Neon Postgres — staging database (isolated from production)
  DATABASE_URL: z
    .string()
    .url()
    .optional()
    .describe('Neon staging database connection string'),
});
