/**
 * TokoBoss Design Tokens
 *
 * Shared design system tokens for web and mobile.
 * Web uses these via Tailwind CSS; mobile uses them directly.
 */

/**
 * Color Palette - Pastel Theme
 * Soft, accessible colors suitable for Indonesian MSME audience
 */
export const colors = {
  // Primary - Soft Blue (trust, professionalism)
  primary: {
    50: '#f0f7ff',
    100: '#e0effe',
    200: '#bae0fd',
  ...
  // Secondary - Soft Mint (growth, success)
  secondary: {
    50: '#f0fdf7',
    100: '#dcfce9',
    200: '#bbf7d2',
  ...
  // Accent - Soft Coral (attention, warmth)
  accent: {
    50: '#fff5f5',
    100: '#ffe4e6',
    200: '#fecdd3',
