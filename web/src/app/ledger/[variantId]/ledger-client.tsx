...
export function LedgerClient({ variantId }: { variantId: string }) {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        // const stockData = await getStockBalance(variantId);
        // const ledgerData = await getLedgerEntries(variantId);
